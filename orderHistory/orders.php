...
$query = "SELECT * FROM `pembelian` WHERE id_pelanggan = " . $_SESSION['id_users'];
...
<head>
    ...
    <title>Order History - Tokotoki</title>
        ...
        <div class="container">
            ...
            <div class="table-container">
                <table class="table border-secondary">
                    <thead>
                        <tr>
                            <th id="short" scope="col">NO</th>
                            <th id="short" scope="col">TIME STAMP</th>
                    ...
                    <tbody>
                        ...
                        while ($data = mysqli_fetch_array($sql)) { ?>
                            <?php if ($data['id_status'] == 6) { ?>
                                <tr>
                                    <th id="short" scope="row">
                                        <?= $i++ ?>
                                    </th>
                                    <td id="short">
                                        <a href="orderStatus/orderStatus.php?id_pembelian=<?= $data['id_pembelian'] ?>"><span class="fa fa-search"></span></a>
                                    </td>
                                    <td id="order-placed" class="status"><span>Order Placed</span></td>
                                    <td class="code">
                                        <?= $data['id_pembelian'] ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>Rp
                                        <?= str_replace(",", ".", number_format($data['total_pembelian'])) ?>
                                    </td>
                                    <td></td>
                                </tr>
                            <?php } else if ($data['id_status'] == 7) { ?>
                                <tr>
                                    ...
                                    <td id="short">
                                        <a href="orderStatus/orderStatusPaymentConfirmed.php"><span class="fa fa-search"></span></a>
                                    </td>
                                    <td id="payment-confirmed" class="status"><span>Payment Confirmed</span></td>
                                    <td class="code">
                                        <?= $data['id_pembelian'] ?>
                                    </td>
                                    <td>
                            ...
                            <?php } else if ($data['id_status'] == 3) { ?>
                                <tr>
                                    ...
                                    <td id="order-sent" class="status"><span>Order Sent</span></td>
                                    <td class="code">
                                        <?= $data['id_pembelian'] ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="send-button" onclick="Accept(<?= $data['id_pembelian']; ?>)">
                                            Accept
                                        </div>
                                    </td>
                                </tr>
                            <?php } else if ($data['id_status'] == 4) { ?>
                                <tr>
                                    ...
                                    <td id="accepted" class="status"><span>Accepted</span></td>
                                    <td class="code">
                                        <?= $data['id_pembelian'] ?>
                                    </td>
                                    <td>
                            ...
                            <?php } else if ($data['id_status'] == 5) { ?>
                                <tr>
                                    ...
                                    <td id="cancelled" class="status"><span>Cancelled</span></td>
                                    <td class="code">
                                        <?= $data['id_pembelian'] ?>
                                    </td>
                                    <td>
                        ...
                        <!-- <tr>
                            <th id="short" scope="row">1</th>
                            <td id="short">
                                <a href="orderStatus/orderStatus.php"><span class="fa fa-search"></span></a>
                            </td>
                            <td id="order-placed" class="status"><span>Order Placed</span></td>
            ...
            <div class="back">
                <div class="back-button" onclick="location.href='../transactionPayment/transaction.php'">
                    SEE TRANSACTION AND PAYMENT</div>
            </div>
        </div>
...
<script>
    function Accept(id) {
        if (confirm('Konfirmasi Barang Sudah Diterima?')) {
            console.log(id);
            location.href = '../include/proses/accept.php?id_pembelian=' + id;
        }
    }
</script>
