...
<head>
  ...
  <title>Login User - Tokotoki</title>
  <!-- BOOTSTRAP STYLES-->
...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="box col-md-4 bg-dark ps-5 pe-5 text-center text-white" style="border-radius: 20px;">
        <img src="images/logo1.png" alt="logo" style="width:17em; margin-bottom: 35px;" class="pb-0">
        <form method="post" action="include/proses/login.php">
          ...
          <button class="btn btn-warning text-center fw-bold ps-5 pe-5 mt-3 mb-4" name="login" style="border-radius: 10px;">LOGIN</button>
          <br>
