                ...
                <form action="../expedition/expedition.php" method="POST" class="row g-3 needs-validation" novalidate autocomplete="off">
                    ...
                    <div class="address d-flex mb-2">
                        <div class="district col-8">
                            ...
                            <input type="text" id="street" name="street" class="form-control" placeholder="ex: Jl. Kenari No. 22" required>
    ...
    <script>
        $(document).ready(function() {
            $("#selectcity").on("change", function() {
                var v = $(this).val();
                let row = Array.from(document.querySelectorAll('#tariff'), ({
                    value
                }) => value);
                let tempArr = document.querySelectorAll('#tariff');
                $("#tariff").filter(function() {
                    var p = document.getElementById("selectcity").selectedIndex - 1;
                    var price = row[p];
