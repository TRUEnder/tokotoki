...
<body>
    ...
    <form method="POST" action="../payment/payment.php" class="main-container">
                        ...
                        ?>
                            <div id="product1" class="product d-flex align-items-center">
                                ...
                                <div class="product-detail">
                                    ...
                                    <div class="quantity">
                                        <?= $data['jumlah'] ?> product(s)
                                    </div>
                                </div>
                                <div class="subtotal flex-fill">Rp
            ...
            <div class="sidebar col-5">
                <div class="box" id="rightbox">
                    ...
                    <div class="product-shipping row">
                        ...
                        <div class="value col-7">Rp
                            <?= str_replace(",", ".", number_format($tarif * $total_weight['total'])) ?>
                        </div>
                    </div>
                    ...
                    <div class="total-payment row d-flex align-items-center">
                        ...
                        <div class="value col-7">Rp
                            <?= str_replace(",", ".", number_format($total + ($tarif * (int)$total_weight['total']))) ?>
                        </div>
                    </div>

                    <button class="order w-full" type="submit">Make
                        an Order</button>
                </div>
            </div>
        </div>
        ...
        <?php $total = (int)$total + ((int)$tarif * (int)$total_weight['total']) ?>
        <input type="text" id="setTotal" name="total" value="<?= $total ?>">
        <input type="hidden" name="kota" value="<?= $kota['nama_kota'] ?>">
        <input type="hidden" name="tarif" value="<?= $tarif ?>">
        <input type="hidden" name="berat" value="<?= $total_weight['total'] ?>">
