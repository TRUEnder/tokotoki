...
<body>
    ...
    <div class="main-container">
        <div class="nav-bar d-flex w-100">
            ...
            <div class="edit">
                ...
                <ul class="edit-menu dropdown-menu" aria-labelledby="editDropdown">
                    <li><a class="dropdown-item" href="addProduct/addProduct.php?animal=<?= $animal ?>">ADD PRODUCT</a>
                    </li>
                    <li><a class="dropdown-item" href="addProductType/addProductType.php?animal=<?= $animal ?>">ADD
                            PRODUCT TYPE</a></li>
                    <li><a class="dropdown-item" href="editProductType/editProductType.php?animal=<?= $animal ?>">EDIT
                            PRODUCT TYPE</a>
                    </li>
                </ul>
            </div>
            ...
            <table class="table border-secondary">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="fix">IMAGE</th>
                        <th scope="col">OPTION</th>
                    </tr>
                    <tr id="empty2" style="display: none;">
                        <td>
                            <h2 class="mt-5 text-center">Empty</h2>
                        </td>
                    </tr>
                </thead>
        ...
        <div class="back-button d-flex align-items-center justify-content-center" onClick="location.href='../editCatalog.php'">
