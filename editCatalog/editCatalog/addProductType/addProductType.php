...
<body>
                ...
                <ul class="navbar-nav me-4 mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../../../transaction/transaction.php">TRANSACTION</a>
                            </li>
    ...
    <div class="main-container">
        <div class="nav-bar">
            <div class="nav">
                <div class="nav-menu" id="page1" onclick="location.href='../addProduct/addProduct.php?animal=<?= $animal ?>'" style="cursor: pointer">ADD PRODUCT</div>
                <div class="nav-menu" id="page2">ADD
                    PRODUCT TYPE
                </div>
                <div class="nav-menu" id="page3" onclick="location.href='../editProductType/editProductType.php?animal=<?= $animal ?>'" style="cursor: pointer">EDIT
                    PRODUCT TYPE</div>
            </div>
        ...
        <div class="main">
            <form action="add.php" method="POST">
                <div class="add-type">
                    <label class="form-label" style="font-size: 16px; font-weight: 500">ADD NEW PRODUCT TYPE</label>
                    <input type="text" name="name" class="form-control" type="text" placeholder="Product Type">
                </div>
                <div class="submit-button">
                    <button type="submit" class="btn btn-warning d-flex align-items-center justify-content-md-around">
                        <img src="../../../images/icons8-plus.png" style="width: 20px; height: 20px;" />
                        ADD
                    </button>
                </div>
            </form>
