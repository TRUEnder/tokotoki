...
<body>
  <div class="container">
    <div class="row justify-content-center">
      <div class="box col-md-4 bg-dark d-flex justify-content-center flex-wrap text-center text-white" style="border-radius: 20px;">
        <img src="images/logo1.png" alt="logo" style="width:17em; margin-bottom: 40px;" class="pb-0">
        <form action="include/proses/daftar.php" method="post" class="form-horizontal col-9">
          ...
          <button class="btn btn-warning text-center fw-bold ps-5 pe-5 mt-3 mb-4" name="daftar" type="submit">SIGN
            UP</button>
          <br>
