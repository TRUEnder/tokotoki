...
$query = "SELECT * FROM product WHERE animalType = 'Cat' AND prodType = 'Foods'";
$sql = mysqli_query($conn, $query);

$query2 = "SELECT * FROM product WHERE animalType = 'Cat' AND prodType = 'Shampoo'";
$sql2 = mysqli_query($conn, $query2);

$query3 = "SELECT * FROM product WHERE animalType = 'Cat' AND prodType = 'Accessories'";
$sql3 = mysqli_query($conn, $query3);

$query4 = "SELECT * FROM product WHERE animalType = 'Cat' AND prodType = 'Medicine'";
$sql4 = mysqli_query($conn, $query4);

$query5 = "SELECT * FROM product WHERE animalType = 'Cat' AND prodType != 'Foods' AND prodType != 'Shampoo' AND prodType != 'Accessories' AND prodType != 'Medicine'";
...
<head>
    ...
    <title>Product Catalog Cat - Tokotoki</title>
</head>
