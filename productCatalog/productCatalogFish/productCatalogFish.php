...
$query = "SELECT * FROM product WHERE animalType = 'Fish' AND prodType = 'Foods'";
$sql = mysqli_query($conn, $query);

$query2 = "SELECT * FROM product WHERE animalType = 'Fish' AND prodType = 'Shampoo'";
$sql2 = mysqli_query($conn, $query2);

$query3 = "SELECT * FROM product WHERE animalType = 'Fish' AND prodType = 'Accessories'";
$sql3 = mysqli_query($conn, $query3);

$query4 = "SELECT * FROM product WHERE animalType = 'Fish' AND prodType = 'Medicine'";
$sql4 = mysqli_query($conn, $query4);

$query5 = "SELECT * FROM product WHERE animalType = 'Fish' AND prodType != 'Foods' AND prodType != 'Shampoo' AND prodType != 'Accessories' AND prodType != 'Medicine'";
...
<head>
    ...
    <title>Product Catalog Fish - Tokotoki</title>
</head>
    ...
    <div class="main-container">
        <div class="nav-bar d-flex">
            <div class="pet-type d-flex align-items-center justify-content-end">
                <img src="../../images/fish circle.png" alt="">
                <img src="../../images/fish teks.png" alt="">
            </div>
            <div class="line"></div>
            <div class="types">
