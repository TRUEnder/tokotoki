...
<head>
    ...
    <title>Product Detail - Tokotoki</title>
</head>
...
<body>
            ...
            <div class="navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item"
                                    href="../../../transactionPayment/transaction.php">TRANSACTION</a></li>
                            <li><a class="dropdown-item" href="../../../orderHistory/orders.php">ORDER HISTORY</a></li>
                            <li><a class="dropdown-item"
                                    href="https://drive.google.com/file/d/1v-t_LLCzYGEVRAuKNjngG3G3Fr6LXqp0/view">HOW TO
                                    USE</a></li>
                ...
                <div class="d-flex align-items-center flex-grow-1">
                    ...
                    <div style="width: 20%" class="row">
                        ...
                        <div class="col-6">
                            <div class="d-flex align-items-center justify-content-center">
                                <a class="nav-link" href="../../../include/proses/logout.php"
                                    style="color: #E3E3E3;">LOG OUT</a>
                            </div>
                        </div>
                        <?php } ?>
                    </div>
        ...
        <div class="row">
            <div class="left-side col-5">
                <div class="product-image">
                    <img src="../../../images/product/627cfd5314e9f.jpg" alt="">
            ...
            <div class="right-side col-4">
                ...
                <div class="third-row row d-flex align-items-center">
                    <div id="price" class="price col-8">Rp
    ...
    <div class="footer">
        ...
        <div class="cart">
            ...
            <img class="cart" src="../../../images/my cart.png" alt=""
                onclick="location.href='../../../myCart/myCart.php'">
            <?php } ?>
        </div>
    </div>
