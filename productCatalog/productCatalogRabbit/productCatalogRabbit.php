...
$query = "SELECT * FROM product WHERE animalType = 'Rabbit' AND prodType = 'Foods'";
$sql = mysqli_query($conn, $query);

$query2 = "SELECT * FROM product WHERE animalType = 'Rabbit' AND prodType = 'Shampoo'";
$sql2 = mysqli_query($conn, $query2);

$query3 = "SELECT * FROM product WHERE animalType = 'Rabbit' AND prodType = 'Accessories'";
$sql3 = mysqli_query($conn, $query3);

$query4 = "SELECT * FROM product WHERE animalType = 'Rabbit' AND prodType = 'Medicine'";
$sql4 = mysqli_query($conn, $query4);

$query5 = "SELECT * FROM product WHERE animalType = 'Rabbit' AND prodType != 'Foods' AND prodType != 'Shampoo' AND prodType != 'Accessories' AND prodType != 'Medicine'";
    ...
    <div class="main-container">
        <div class="nav-bar d-flex">
            <div class="pet-type d-flex align-items-center justify-content-end">
                <img src="../../images/rabbit circle.png" alt="">
                <img src="../../images/rabbit teks.png" alt="">
            </div>
            <div class="line"></div>
            <div class="types">
                <img src="../../images/cat circle.png" onclick="location.href='../productCatalogCat/productCatalogCat.php'" style="cursor: pointer">
                <img src="../../images/dog circle.png" onclick="location.href='../productCatalogDog/productCatalogDog.php'" style="cursor: pointer">
