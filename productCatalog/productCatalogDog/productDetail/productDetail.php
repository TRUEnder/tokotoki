...
<body>
                ...
                <ul class="navbar-nav me-4 mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../../productCatalog/productCatalog.php">OUR PRODUCTS</a>
                            </li>
                            <li><a class="dropdown-item" href="../../../transactionPayment/transaction.php">TRANSACTION</a></li>
    ...
    <script>
        ...
        var frame = document.getElementsByClassName("product-image");
